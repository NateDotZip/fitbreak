...
import { Link, useBase, useRecordIds } from "@airtable/blocks/ui";
import { Heading } from "@airtable/blocks/ui";
import { Button } from "@airtable/blocks/ui";
import {STUDENT_COUNTDOWN, TEACHER_EXERCISE_STATS, TEACHER_HOME} from '../index'
...
export default function StudentHome(props) {
    const { setNav, setActiveSession, setIsTeacher } = props
    const base = useBase()
    const table = base.getTableByNameIfExists("Sessions")
    const view = table.getViewByNameIfExists("Active")
    ...
    if (records.length === 0) {
      return (
        ...
        <Heading>Welcome to FitBreak! Wait here until your teacher starts an exercise.</Heading>
        <br/><br/>
  ...
  <Link
    onClick={() => {setIsTeacher(true); setNav(TEACHER_HOME);}}
    icon="bell"
  >
    Are you the teacher? Click Here. 
      ...
      setActiveSession(records[0])
      setNav(STUDENT_COUNTDOWN)
      return <></>
    }
